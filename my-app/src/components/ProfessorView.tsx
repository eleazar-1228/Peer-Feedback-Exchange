        ...
        <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <option>CS 301 - Advanced Software Engineering</option>
                    <option>CS 201 - Data Structures</option>
                    <option>DES 301 - UI/UX Design</option>
                    <option>ENGL 202 - Academic Writing</option>
                  </select>
                </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              {/* Upload Area */}
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-purple-400 transition-colors cursor-pointer mb-4">
              ...
              {/* Download Template */}
              <button className="w-full px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center justify-center gap-2 text-sm">
